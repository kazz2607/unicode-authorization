                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col">
                                <input type="text" class="form-control" name="title" placeholder="Vui lòng nhập họ tên..." value="{{old('title')  ?? $mailer->title }}">
                                @error('title')
                                    <div class="msg-error">
                                        {{ $message }}
                                    </div>
                          ...
                          <div class="mb-3 row">
                            ...
                            <div class="col">
                                <textarea rows="10" class="form-control" name="content" placeholder="Vui lòng nhập nội dung..." value="{{old('content')  ?? $mailer->content }}">{{old('content')  ?? $mailer->content }}</textarea>
                                @error('content')
                                    <div class="msg-error">
                                        {{ $message }}
                                    </div>
                          ...
                          <div class="mb-3 row">
                            ...
                            <div class="col">
                            <input type="file" class="form-control" name="file" placeholder="Vui lòng upload file ..." value="{{old('file')  ?? $mailer->file }}">
                            @error('file')
                                <div class="msg-error">
                                    {{ $message }}
                                </div>
                          ...
                          <div class="mb-3">
                            ...
                            <div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" value="{{old('status') ?? '1' }}" {{ $mailer->status == '1' ? 'checked':false}}>
                                <label class="form-check-label">Kích hoạt</label>
                              </div>
                              <div class="form-check form-check-inline">
                                  <input class="form-check-input" type="radio" name="status" value="{{old('status') ?? '0' }}" {{ $mailer->status == '0' ? 'checked':false}}>
